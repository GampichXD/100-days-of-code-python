...
def find_cheapest_flight(data):
    ...
    segment = first_flight["itineraries"][0]["segments"]
    destination = first_flight["itineraries"][0]["segments"][len(segment) - 1]["arrival"]["iataCode"]
    out_date = first_flight["itineraries"][0]["segments"][0]["departure"]["at"].split("T")[0]
    return_date = first_flight["itineraries"][1]["segments"][0]["departure"]["at"].split("T")[0]


    # Initialize FlightData with the first flight for comparison
    cheapest_flight = FlightData(lowest_price, origin, destination, out_date, return_date, len(segment) - 1)
    ...
    for flight in data["data"]:
        ...
        if price < lowest_price:
            ...
            segment = flight["itineraries"][0]["segments"]
            destination = flight["itineraries"][0]["segments"][len(segment) - 1]["arrival"]["iataCode"]
